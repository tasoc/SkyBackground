...
\subsection{Conclusions}
Following the changes to the OJH method, three out of four methods converge around median residuals within one standard deviation of 0. The ML method is the bottleneck in the testing at the moment, and takes significantly longer than other estimates, despite no clear improvement in performance over the others. As it still relies on the polynomial fitting, it falls significantly behind the others in its ability to match large scale structure.\\
